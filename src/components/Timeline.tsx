    ...
    <div className="flex flex-col h-full bg-[#1e293b] text-gray-200 select-none border-t border-gray-700">
       ...
       <div className="h-10 border-b border-gray-700 flex items-center justify-between px-4 bg-[#0f172a]">
          <div className="flex items-center gap-2">
             <button aria-label="Go to start" title="Go to start" onClick={() => setTime(0)} className="p-1 hover:text-white text-gray-400 rounded focus-visible:ring-2 focus-visible:ring-editor-accent focus-visible:outline-none"><SkipBack size={16} /></button>
             ...
             <button aria-label="Go to end" title="Go to end" onClick={() => setTime(duration)} className="p-1 hover:text-white text-gray-400 rounded focus-visible:ring-2 focus-visible:ring-editor-accent focus-visible:outline-none"><SkipForward size={16} /></button>
          ...
          <div className="flex items-center gap-2">
             <button
                ...
                className="flex items-center gap-1 text-xs px-2 py-1 rounded bg-gray-700 hover:bg-[#4ade80] hover:text-black disabled:opacity-50 transition-colors focus-visible:ring-2 focus-visible:ring-editor-accent focus-visible:outline-none disabled:cursor-not-allowed"
             >

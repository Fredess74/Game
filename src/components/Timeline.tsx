       ...
       <div className="h-10 border-b border-gray-700 flex items-center justify-between px-4 bg-[#0f172a]">
          ...
          <div className="flex items-center gap-2">
             <button
                ...
                disabled={!selectedId}
                className="flex items-center gap-1 text-xs px-2 py-1 rounded bg-gray-700 hover:bg-[#4ade80] hover:text-black disabled:opacity-50 transition-colors focus-visible:ring-2 focus-visible:ring-[#4ade80] focus-visible:outline-none"
             >

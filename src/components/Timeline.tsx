    ...
    <div className="flex flex-col h-full bg-[#1e293b] text-gray-200 select-none border-t border-gray-700">
       ...
       <div className="h-10 border-b border-gray-700 flex items-center justify-between px-4 bg-[#0f172a]">
          <div className="flex items-center gap-2">
             <button
                onClick={() => setTime(0)}
                className="p-1 rounded hover:text-white text-gray-400 focus-visible:ring-2 focus-visible:ring-[#4ade80] focus-visible:outline-none"
             ...
             <button
                ...
                className="p-1 rounded hover:text-white text-[#4ade80] focus-visible:ring-2 focus-visible:ring-[#4ade80] focus-visible:outline-none"

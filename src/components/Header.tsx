    ...
    <header className="h-12 bg-editor-panel border-b border-editor-border flex items-center justify-between px-4 select-none z-50">
      ...
      <div className="flex items-center gap-4">
          ...
          <button
            ...
            title={isExporting ? 'Export in progress' : 'Export Video'}
            className="btn-primary flex items-center gap-2 shadow-lg shadow-editor-accent/20 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-editor-accent focus-visible:outline-none"
          >
